...
var getSelected = function () {
  ...
  if (t != "") {
    ...
    return [
      ...
      t,
    ]; // 0: selected text, 1: location in document, 2: all text
  }
  return [null, null];
};
...
class PopupTooltip {
  ...
  createTitle(title_text) {
    ...
    strong_div.setAttribute("style", "font-size: 17px");
  ...
  createText(content_text, text_class = "e") {
    ...
    text_html.setAttribute("style", "font-size: 17px");
